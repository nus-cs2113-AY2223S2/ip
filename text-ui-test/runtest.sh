...
if [ $? -eq 0 ]; then
  echo "Test result [output vs expected_output]: PASSED"
else
  echo "Test result [output vs expected_output]: FAILED"
fi
...
if [ $? -eq 0 ]; then
  echo "Test result [duke.txt vs expected_duke.txt]: PASSED"
else
  echo "Test result [duke.txt vs expected_duke.txt]: FAILED"
fi
...
if [ $? -eq 0 ]; then
  echo "Test result [output2 vs expected_output2]: PASSED"
  exit 0
else
  echo "Test result [output2 vs expected_output2]: FAILED"
  exit 1
fi
