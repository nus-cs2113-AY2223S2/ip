    ...
    public static Command handleUserInputs(String userInput, TaskList taskList){
        ...
        try {
            if (command.equals("todo")) {
                ...
                return new MarkTaskCommand(cases[1], taskList);
            } else if (command.equals("unmark")) {
                return new UnmarkTaskCommand(cases[1], taskList);
            } else if (command.equals("delete")) {
                return new DeleteTaskCommand(cases[1], taskList);
            } else if (command.equals("find")) {
                return new FindTaskCommand(cases[1]);
