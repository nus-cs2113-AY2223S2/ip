...
public class DeleteCommand extends Command {
    ...
    public static final String REMAINING_TASK_COUNT = " You now have %d task[s] in the list.";
    ...
    public CommandResult execute() {
        ...
        output = String.join(Ui.NEW_LINE, output, OUTPUT_MESSAGE,
                ("   " + taskList.getTaskFullDetails(taskNumber)), DeleteCommand.REMAINING_TASK_COUNT);
