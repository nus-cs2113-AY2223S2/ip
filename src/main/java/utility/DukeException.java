...
/**
 * Represents a custom Exception class for Duke. It contains a description of the errors thrown by Duke.
 * The description will describe the error found, and it will be displayed to the user.
 */
