...
public class TaskList {
    ...
    public void addTask(Task task) {
        ...
        String addedMessage = "\tYes m'Lord. Thy task hast been added:\n" + "\t  " + task;
    ...
    public void deleteTask(int deleteIndex) {
        ...
        String removeMessage = "\tHuzzah. I hast did remove this task:\n" + "\t  " + taskToDelete;
        String sizeMessage = printSize();
    ...
    public String printSize() {
        String sizeMessage = "\tThou hast " + this.tasks.size() + " tasks in thy list.";
    ...
    public void markTask(int taskNum) {
        ...
        String markMessage = "\tVoila! Thy task hath been marked done:\n" + "\t  " + currentTask;
    ...
    public void unmarkTask(int taskNum) {
        ...
        String unmarkMessage =
                "\tAye m'Lord, I hast marked thy task as undone:\n" + "\t  " + currentTask;
    ...
    public void printTasks() {
        ...
        messagePacket[0] = "\tHere art thou tasks in thy list:";
        int messageCount = 1;
    ...
    public void printFilteredTasks(String filter) throws NoTasksException {
        ...
        messagePacket.add(String.format("\tHere art thou tasks yond matches '%s':", filter));
