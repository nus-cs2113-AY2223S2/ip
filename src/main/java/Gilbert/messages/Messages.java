...
public final class Messages {
    public final static String SPACE =
            ...
            "|______|______|______|______|______|______|______|______|______|______|";
    public final static String TASKS = "Here are the Gilbert.tasks in your list:\n";
    ...
    public final static String HELP = "Below are some of the Gilbert.commands that you can use, please type them out\n" +
            "in the same order (ignore the <> brackets):\n" +
            "\n" +
            "There are 3 types of Gilbert.tasks that can be inserted into Gilbert. They are:\n" +
            "todo \t\t\t|todo <task to be done>\n" +
            "event \t\t\t|event <task to be done>\n" +
            "deadline \t\t|deadline <task to be done> / <time>\n" +
            "\n" +
            "Following which, there are 6 Gilbert.commands that can be used in Gilbert:\n" +
            "list\t\t\t|lists out the existing Gilbert.tasks\n" +
            ...
            "find <keyword>\t|shows the Gilbert.tasks containing the corresponding keyword\n" +
            "bye\t\t\t\t|exits Gilbert\n" + SPACE;
