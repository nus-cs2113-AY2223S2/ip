    ...
    public static void main(String[] args){
        ...
        while (true) {
            ...
            if (line.startsWith("list")) {
                ...
                if (line.equals("find") || (line.substring(5)).isBlank()) {
                    ...
                    for (int j = 0; j < tasks.size(); j++) {
                        ...
                        if (task.contains(find)) {
                            try {
                                System.out.print(b + "." + type.get(j) + done.get(j) + tasks.get(j));
                                if ((type.get(j)).equals("[T]")) {
                                    System.out.println("");
                                }
                                if ((type.get(j)).equals("[D]")) {
                ...
                if (line.equals("dated") || (line.substring(5)).isBlank()) {
                    System.out.println("Oops! The description cannot be left empty.");
                }
                else {
                    ...
                    try {
                        ...
                        LocalDateTime datetime = LocalDateTime.parse(datetimestr, formatter);
                        System.out.println("Tasks during this time period:");
                        int b = 1;
                        for (int j = 0; j < tasks.size(); j++) {
                ...
                if (!line.startsWith("bye")) {
                    ...
                    System.out.println("list   mark   unmark   todo   deadline   event   find   dated");
                }
            }
        }
