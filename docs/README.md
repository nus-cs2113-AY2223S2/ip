...
#### 2.2.1 Add a deadline task: ```deadline```
...
#### 2.2.4 List all tasks and task statuses: ```list```
* Format: ```list```
* Example:
...
#### 2.2.5 Mark a task as done: ```mark```
* Format: ```mark {index}```
* Example:
...
#### 2.2.6 Unmark a task as not done: ```unmark```
* Format: ```unmark {index}```
* Example:
...
#### 2.2.7 Find a task by keywords in the description: ```find```
* Format: ```find {keyword}```
