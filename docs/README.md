...
2. Download the latest version of Duke from [here](https://github.com/tyuyang/ip/releases/latest). Note that you do not need to download the zip files for the application.
...
5. Type ```java -jar Duke.jar``` in the terminal to open the application. You should see the welcome message "Hello, I am Duke." on the next line.
